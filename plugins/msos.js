...
conn.sendButtonImg(m.chat, json, '*By StarBot and ConfuMods*\n*https://api-alc.herokuapp.com/api/chicas/muslos?&apikey=ConfuMods*', '©Starbot', 'SIGUIENTE', `${usedPrefix + command}`, m, false)
}
